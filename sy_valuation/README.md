...
KTDS 기업가치평가 시트(Excel)의 컨셉을 웹 기반으로 확장한 통합 시스템.

> ⚠️ 원본 Excel 파일(`기업가치평가_계산_시트_KTDS_24.07.09.xlsx1`)은 NASCA DRM 으로 암호화되어 직접 읽을 수 없어, 표준 가치평가 방법론(DCF / RIM / 멀티플 / Graham / Lynch)을 폭넓게 구현했습니다. DRM 해제 후 Excel 의 정확한 가중치/가정으로 교체하시면 됩니다.
